...
const caps = [
  ...
  { icon: '✦', title: 'Ask anything about your customers. Get a decision-ready answer.', body: 'Natural language queries across your research data. Ask Rishi surfaces what matters from your studies — themes, patterns, and signals — in seconds, not spreadsheets.', tag: 'Ask Rishi', color: '#60a5fa', highlight: true },
  { icon: '◇', title: 'Get research live in hours. Turn customer signals into decisions in real time.', body: 'Multi-format studies with skip logic and branching — live in hours. Research moves at the speed of your roadmap, not weeks behind it.', tag: 'Study Builder', color: '#34d399' },
  { icon: '◉', title: 'Capture meaning from text, audio, or video — whichever fits your research', body: 'Choose the format that best suits your research goal. Rik AI handles transcription, analysis, and insight extraction — regardless of how your participants respond.', tag: 'Multi-Format', color: '#f59e0b' },
