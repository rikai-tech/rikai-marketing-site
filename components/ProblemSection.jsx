...
const problems = [
  ...
  { icon: '◈', color: '#a78bfa', title: 'Dashboards show metrics. They rarely explain decisions.', body: "Dashboards show what happened — but not why, or what to do next. Your team shouldn't have to bridge that gap manually every single time." },
  { icon: '⚡', color: '#f59e0b', title: 'Every handoff loses context. Every tool loses signal.', body: 'Surveys here, video there, analysis somewhere else. Each handoff loses signal. Rik AI brings every format together so nothing falls through the cracks.' },
      ...
      <div className="container" style={{ position: 'relative' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <p className="fu d1" style={{ fontSize: 17, color: 'var(--text-2)', maxWidth: 540, margin: '20px auto 0', lineHeight: 1.7 }}>
            Rik AI connects feedback, research, and behavioural signals into intelligence your team can understand, trust, and act on in real time.
          </p>
        </div>
